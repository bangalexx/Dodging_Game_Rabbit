...
public class Spike {
    ...
    public Spike(Context context){
        spike[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.img1);
        spike[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.img2);
        spike[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.img3);
        random = new Random();
        resetPosition();
